...
docker run -d --network $NETWORK $VOLUME_MOUNT_ARG -e STRICT_CONNECTION_CHECK=true --name $HTTPPROXYSERVER -p 8082:8080 -e NATS_SERVER_URL=$CLOUDNATSURL $HTTPPROXYSERVER_FULL_IMG
